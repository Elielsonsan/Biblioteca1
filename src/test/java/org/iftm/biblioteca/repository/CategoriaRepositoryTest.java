...
// Carrega o contexto do Spring apenas para os componentes necessários para o
// teste
class CategoriaRepositoryTest {
    ...
    void setUp() {
        ...
        // Persiste as categorias usando TestEntityManager para garantir que elas
        // existam
    ...
    void findAll_DeveRetornarTodasCategoriasPersistidas() {
        ...
        assertThat(categorias).extracting(Categoria::getNome).containsExactlyInAnyOrder("Fantasia",
                "Ficção Científica");
    }
    ...
    void findById_QuandoIdNaoExiste_DeveRetornarOptionalVazio() {
        ...
        // O método isEmpty() também pode ser usado para verificar se o Optional está
        // vazio.
        // assertThat(optionalCategoria).isEmpty(); // Outra forma de verificar se o
        // Optional está vazio
        // O método isEmpty() verifica se o Optional está vazio.
        // O método isNotPresent() verifica se o Optional não contém um valor.
        // O método isPresent() verifica se o Optional contém um valor.
        // O método get() retorna o valor contido no Optional.
        // O método orElse() retorna o valor contido no Optional ou um valor padrão se
        // estiver vazio.
